/*
2 types of queries:
1. Add a line segment y = ax + b for x in [l, r]
2. Query the minimum value of y for a given x, where y is defined by the segments added so far.

to make it get max value you can just insert negative lines and multiply the result by -1.
*/
const ll inf = 2e18;
struct Line {
  ll m, c;
